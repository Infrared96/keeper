...
public class RequestManager {
    ...
    public RequestManager(Facade facade) {
        ...
        this.postRequests = new String[]{"CREATE_USER", "CREATE_DISH", "CREATE_PRODUCT", "CREATE_ORDER", "UPDATE_USER", "UPDATE_DISH", "UPDATE_PRODUCT", "UPDATE_ORDER", "UPDATE_NEW_ORDERS", "UPDATE_ORDER_PRICE"};
